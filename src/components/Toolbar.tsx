                ...
                {menuItems.map((item) => (
                  <button
                    ...
                    style={{
                      ...
                      background: item.accent ? '#c8f135' : item.active ? 'rgba(200,241,53,0.12)' : 'rgba(255,255,255,0.05)',
                      border: item.active ? '1px solid rgba(200,241,53,0.35)' : '1px solid rgba(255,255,255,0.07)',
                      color: item.accent ? '#0a0b16' : item.active ? '#c8f135' : item.disabled ? 'rgba(255,255,255,0.2)' : 'rgba(255,255,255,0.65)',
